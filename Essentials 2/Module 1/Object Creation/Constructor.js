...
console.log(coloredPoint1.constructor.name);//constructor function name
console.log(typeof coloredPoint1.constructor);//function

let a = {};
console.log(typeof a.constructor);//function

//Cannot enumerate inherited fields from generic Object Constructor
for(key in coloredPoint1){
    console.log(key);
}
console.log(Object.keys(coloredPoint1));